      ...
      <div className="flex flex-col md:flex-row gap-5">
        <div className="flex gap-3">
          <p className="p-3 border border-gray-400 rounded text-gray-800">
            ...
            with questions in the &quot;Questions&quot; section, remember you
            can provide more than five options. When creating a new question,
            type in the question and give multiple choices. In the &quot;Correct
          ...
          <p className="p-3 border border-gray-400 rounded text-gray-800">
            ...
            click &quot;Add New Question.&quot;` Fill in the details and save.
            To update a question, locate it, edit as needed, and save the
            changes.
          </p>
        </div>
      </div>
