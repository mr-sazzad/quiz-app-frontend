...
const SignUp = () => {
  ...
  return (
    <div className="max-w-[1100px] mx-auto w-full h-[85vh] flex justify-center items-center">
      <div className="flex flex-col md:flex-row justify-between md:items-center lg:px-[50px] px-[30px] w-full py-10">
        {/* banner part */}
            ...
            <button
              ...
              className={`p-2 ${
                Object.keys(errors).length === 0
                  ? "bg-gray-200 hover:bg-green-500 hover:text-white transition duration-1000 rounded"
